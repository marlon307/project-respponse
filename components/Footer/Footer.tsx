      ...
      <div className={ style.footercolumn }>
        <section>
          ...
          <ul className={ style.social }>
            <li>
              <Link href="https://www.instagram.com/_marlon307/" target="_blank" rel="noreferrer" aria-label="Instagram _marlon307" title="Instagram _marlon307">
                { ' ' }
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <li>
              <Link href="https://www.linkedin.com/in/marlon307/" target="_blank" rel="noreferrer" aria-label="Linkedin marlon307" title="Linkedin marlon307">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <li>
              <Link href="https://twitter.com/_marlon307" target="_blank" rel="noreferrer" aria-label="Twitter _marlon307" title="Twitter _marlon307">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
